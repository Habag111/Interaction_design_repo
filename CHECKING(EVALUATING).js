...
function checking_stage(){
  ...
  for (const line of lines) {
    ...
    for (const char of line) {
      ...
      if (!isEvaluatingLine) {
        fill(0);
        drawLetter2(letter, x, y, cellWidth, cellHeight);
      } else if (evalAlpha > 0) {
        fill(0, evalAlpha);
        drawLetter2(letter, x, y, cellWidth, cellHeight);
      }
...
function drawLetter2(letter, xOffset, yOffset, cellWidth, cellHeight) {
